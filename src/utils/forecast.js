...
module.exports = forecast = (longitude, latitude, callback) => {
    ...
    request({url, json: true}, (error, response, body) => {
        if (error) {
            ...
            callback(undefined, `It is ${currentData.weather_descriptions[0]}, currently ${currentData.temperature} degrees out and it feels like ${currentData.feelslike} degrees out.`);
        }
    })
};